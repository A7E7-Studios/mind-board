...
Version 0.2.1 at commit `a29f2f7` passed [clean Windows validation](https://github.com/A7E7-Studios/mind-board/actions/runs/34121565782). Clean CI validation for 0.2.2 is required before publication. macOS/Linux desktop behavior remains unverified.
