...
| Paste placement | Mouse target for file/HTML images, styled/empty notes and plain text; pan/zoom coordinate conversion, center fallback, unchanged viewport, and target captured before asynchronous decoding |
